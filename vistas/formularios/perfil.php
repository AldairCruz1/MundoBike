          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 id="m-nombre" class="profile-username text-center"></h3>

                <p id="m-tipo" class="text-muted text-center"></p>

                <strong><i class="fas fa-id-card"></i> DNI</strong>

                <p id="m-dni" class="text-muted"></p>

                <hr>

                <strong><i class="fas fa-file-signature"></i> Nombres</strong>

                <p id="m-nombres"class="text-muted"></p>

                <hr>

                <strong><i class="fas fa-file-signature"></i> Apellidos</strong>

                <p id="m-apellidos" class="text-muted"></p>

                <hr>

                <strong><i class="fas fa-mobile-alt"></i> Celular</strong>

                <p id="m-celular" class="text-muted"></p>
                ...
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="timeline">
                    ...
                    <div class="timeline timeline-inverse">
                      ...
                      <!-- timeline item -->
                      <div>
                        <i class="fas fa-edit bg-purple"></i>

                        <div class="timeline-item">
                          <span class="time"><i class="far fa-clock"></i> Ahora</span>

                          <h3 class="timeline-header"><a href="#">Modificacion</a> actualizacion...</h3>
                    ...
                    <div class="card-body box-profile">
                      ...
                      <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                          <b>Nombres</b> <a id="m-nombres" class="float-right"></a>
                        </li>
                        <li class="list-group-item">
                          <b>Apellidos</b> <a id="m-apellidos" class="float-right"></a>
                        </li>
                        <li class="list-group-item">
                          <b>DNI</b> <a id="m-dni" class="float-right"></a>
                        </li>
                        <li class="list-group-item">
                          <b>Celular</b> <a id="m-celular" class="float-right"></a>
                        </li>
                        <li class="list-group-item">
                          <b>Correo</b> <a id="m-correo" class="float-right"></a>
                        </li>
                      </ul>
                  ...
                  <div class="tab-pane" id="modificar">
                    <form id="formulario" class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="hidden" class="form-control" name="id_usuario" id="id_usuario" placeholder="" required readonly>
                          <input type="number" class="form-control" id="dni" placeholder="DNI" required readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Nombres</label>
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="nombre" placeholder="Nombre" required readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="tab-pane" id="password">
                    <form id="formulario2" class="form-horizontal">
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-4 col-form-label">Contraseña Actual
                          <i id="icon_pass_old" style="float: right"></i>
                        </label>
                        <div class="col-sm-7">
                          <input type="hidden" class="form-control" name="id_usuario" id="id_usuario" placeholder="" required readonly>
                      ...
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-4 col-form-label">Nueva Contraseña
                          <i id="icon_pass_new" style="float: right"></i>
                        </label>
                        <div class="col-sm-7">
                          <input type="password" class="form-control" name="pass_new" id="pass_new" required readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-4 col-form-label">Confirmar Nueva Contraseña
                          <i id="icon_pass_new_2" style="float: right"></i>
                        </label>
                        <div class="col-sm-7">
                          <input type="password" class="form-control" name="pass_new_2" id="pass_new_2" required readonly>
                        </div>
                      </div>
                      <div class="form-group row">
